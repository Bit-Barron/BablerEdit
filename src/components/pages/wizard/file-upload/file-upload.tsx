        ...
        <div className="relative w-full rounded-[10px] bg-muted/50 p-1.5">
          <div className="relative mx-auto w-full overflow-hidden rounded-lg bg-background">
            ...
            <motion.div
              ...
              className="flex flex-col items-center justify-center p-4 cursor-pointer transition-all duration-300 hover:bg-muted/30 rounded-lg group/upload"
            ...
            >
              <div className="mb-2 pointer-events-none transition-transform duration-300 group-hover/upload:scale-105">
                <UploadIllustration />
              </div>

              <div className="mb-2 space-y-1 text-center pointer-events-none">
              ...
              <p className="mt-2 text-muted-foreground text-xs pointer-events-none transition-colors duration-300 group-hover/upload:text-foreground/60">
